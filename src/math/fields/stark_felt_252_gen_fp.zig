// Autogenerated: './src/ExtractionOCaml/word_by_word_montgomery' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case UpperCamelCase --no-prefix-fiat --package-name starkFelt252Fp '' 64 3618502788666131213697322783095070105623107215331596699973092056135872020481 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
// curve description (via package name): starkFelt252Fp
// machine_wordsize = 64 (from "64")
// requested operations: mul, square, add, sub, opp, from_montgomery, to_montgomery, nonzero, selectznz, to_bytes, from_bytes, one, msat, divstep, divstep_precomp
// m = 0x800000000000011000000000000000000000000000000000000000000000001 (from "3618502788666131213697322783095070105623107215331596699973092056135872020481")
//
...
inline fn cmovznzU64(out1: *u64, arg1: u1, arg2: u64, arg3: u64) void {
    ...
    const x2 = cast(
        ...
        cast(
            i128,
            cast(i1, cast(i2, 0x0) - cast(i2, ~~arg1)),
        ) & cast(i128, 0xffffffffffffffff),
    );
...
/// The function toBytesLe serializes a field element NOT in the Montgomery domain to bytes in little-endian order.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
/// Postconditions:
...
pub fn toBytesLe(out1: *[32]u8, arg1: [4]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// The function fromBytesLe deserializes a field element NOT in the Montgomery domain from bytes in little-endian order.
///
/// Preconditions:
///   0 ≤ bytes_eval arg1 < m
/// Postconditions:
